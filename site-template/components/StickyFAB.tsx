...
type Props = { phone: string; theme: Theme }

export default function StickyFAB({ phone, theme }: Props) {
  ...
  return (
    ...
    >
      <a
        href={`tel:${phone}`}
        className="flex items-center gap-2.5 px-8 py-3.5 shadow-xl text-sm font-sans font-semibold tracking-wide transition-opacity hover:opacity-90"
        style={{
